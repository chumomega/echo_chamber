...
class YoutubeClient:
    ...
    def get_video_chamber(self, identifier: str) -> Chamber:
        ...
        if video_response is None or \
            "items" not in video_response or \
            len(video_response["items"]) == 0:
            return None
    ...
    def get_video_comments(self, identifier: str, num_comments: int = None) -> list[Comment]:
